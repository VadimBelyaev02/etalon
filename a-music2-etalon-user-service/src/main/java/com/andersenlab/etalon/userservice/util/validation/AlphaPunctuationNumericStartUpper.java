 ...
 * <p>or
 *
 * <p>1. Starts with <b>uppercase</b> letters or <b>digits</b>
 *
 ...
 * <p>
 *
 * @see AlphaPunctuationNumericStartUpperValidator
 */
@Target({FIELD, PARAMETER})
@Retention(RUNTIME)
@Constraint(validatedBy = AlphaPunctuationNumericStartUpperValidator.class)
public @interface AlphaPunctuationNumericStartUpper {
