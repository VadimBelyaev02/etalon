...
@AllArgsConstructor
public class OpenDepositRequestStrategy implements EmailRequestPreparationStrategy {
  ...
  public BaseEmailRequestDto prepareEmailRequest(ConfirmationEntity confirmation) {
    ...
    confirmationEmailRequestDto.setSubject("Confirmation of create deposit");
