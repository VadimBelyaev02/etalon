...
@Service(CountryCodesStrategy.COUNTRY_CODES_STRATEGY_PREFIX + "en")
@RequiredArgsConstructor
public class CountryCodesStrategyEnImpl implements CountryCodesStrategy {
  ...
  public List<CountryCodesResponseDto> getCountryCodeResponseDto(
    ...
    return countryCodesEntities.stream().map(countryCodesMapper::toDtoEn).toList();
  }
}
