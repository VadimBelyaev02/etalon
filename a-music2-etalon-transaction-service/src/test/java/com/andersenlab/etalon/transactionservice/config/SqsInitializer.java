...
public class SqsInitializer
  ...
  private static final String CREATE_TRANSACTION_QUEUE_PROPERTY_NAME =
      "sqs.queue.create-transaction.name";
  private static final String CREATE_TRANSACTION_DLQ_PROPERTY_NAME =
      "sqs.queue.create-transaction-dlq.name";
  ...
  public static String createTransactionQueueUri;
  ...
  public void initialize(@NotNull ConfigurableApplicationContext applicationContext) {
    ...
    String createTransactionQueue =
        configurableEnvironment.getProperty(CREATE_TRANSACTION_QUEUE_PROPERTY_NAME);
    String createTransactionDlq =
        configurableEnvironment.getProperty(CREATE_TRANSACTION_DLQ_PROPERTY_NAME);
    ...
    String createTransactionDeadLetterQueueUri = createQueue(amazonSQS, createTransactionDlq);
    String createTransactionDlqArn = getQueueArn(amazonSQS, createTransactionDeadLetterQueueUri);
    Map<String, String> redrivePolicyAttributes =
        createRedrivePolicyAttributes(createTransactionDlqArn);
    createTransactionQueueUri = createQueue(amazonSQS, createTransactionQueue);
    setQueueAttributes(amazonSQS, createTransactionQueueUri, redrivePolicyAttributes);
  }
