package com.andersenlab.etalon.depositservice.dto.transaction.request;
...
public record TransactionCreateRequestDto(
    ...
    @Schema(example = "Transaction description") String transactionName,
    @Schema(example = "OPEN_DEPOSIT") Details details,
    @Schema(example = "true") Boolean isFeeProvided,
    @Schema(example = "100")
        @Max(value = 100_000, message = INVALID_AMOUNT)
        @Min(value = 1, message = INVALID_AMOUNT)
